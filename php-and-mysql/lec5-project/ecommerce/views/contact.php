...
<?php ROOT_PATH.require_once 'inc/nav.php'; ?>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form class="col-md-9 m-auto" method="POST"  action="<?php echo url("send-message"); ?>">
                <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control mt-1" id="message" name="content" placeholder="Message" rows="8"></textarea>
